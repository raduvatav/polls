...
$TRANSLATIONS = array(
        ...
        "Users" => "Utilisateurs",
        "Groups" => "Groupes",
       	"Are you sure you want to delete this poll" => "Etes vous sure de vouloir éffacer ce sondage",
        ...
        "You are not allowed to view this poll or the poll does not exist." => "Vous n'étes pas autorisé à voir ce sondage ou bien ce vote n'existe pas.",
        "Error" => "Erreur"
);
